...
moduleTests = testGroup "Module Tests" 
  ...
  , testCase "Find" $
      withTempAcid $ \acid -> do
        ...
        mods1 <- query acid $ FindModules [ComponentKey testPkgKey1 testComp1] ""
        sort (toList mods1) @?= [testMod1,testMod3]
        mods2 <- query acid $ FindModules [ComponentKey testPkgKey1 testComp1] "Test.M"
        toList mods2 @?= [testMod1]
...
testMod1 :: Module
testMod1 = Module testModKey1 def Exposed [testComp1]

testModKey2 :: ModuleKey
testModKey2 = ModuleKey "Test.Module2" testPkgKey1

testMod2 :: Module
testMod2 = Module testModKey2 def Exposed [testComp2]

testModKey3 :: ModuleKey
testModKey3 = ModuleKey "Test.Utils" testPkgKey1

testMod3 :: Module
testMod3 = Module testModKey3 def Exposed [testComp1]