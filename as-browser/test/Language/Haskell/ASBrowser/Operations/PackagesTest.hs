  ...
  , testCase "Versions" $
      withTestAcid $ \acid -> do
        ...
        let testPkgKey1_2 = PackageKey "pkg1" "0.0.2" Packaged
            testPkg1_2 = Package testPkgKey1_2 def def def
  ...
  , testCase "By Local" $
      withTestAcid $ \acid -> do
        ...
        let pkgKeyLoc = PackageKey "mypkg" "0.0.1" Local
            pkgLoc = Package pkgKeyLoc def def def
...
testPkg1 :: Package
testPkg1 = Package testPkgKey1 def def def

testPkgKey2 :: PackageKey
testPkgKey2 = PackageKey "mypkg" "0.0.1" Packaged

testPkg2 :: Package
testPkg2 = Package testPkgKey2 def def def
